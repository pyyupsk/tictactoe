  ...
  <main class="flex h-screen flex-col items-center justify-center">
    ...
    <section class="grid grid-cols-3">
      <div class="flex flex-col items-center">
        ...
        <div class="text-xl font-semibold md:text-2xl lg:text-3xl">{{ scores.player }}</div>
      </div>
      <div class="flex flex-col items-center">
        <h2 class="mb-1 text-sm md:text-lg lg:text-xl">TIE</h2>
        <div class="text-xl font-semibold md:text-2xl lg:text-3xl">{{ scores.tie }}</div>
      </div>
      <div class="flex flex-col items-center">
        <h2 class="mb-1 text-sm md:text-lg lg:text-xl">COMPUTER (O)</h2>
        <div class="text-xl font-semibold md:text-2xl lg:text-3xl">
          {{ scores.computer }}
        </div>
      </div>
    </section>
